...
module.exports.createServer = function(config) {
  ...
  server.get('/init/callback', initEndpoints.callback(config.connectAccountRetrieveTempToken, config.connectAccountRetrieveAuthDatas, cluestrClient, config.connectUrl));

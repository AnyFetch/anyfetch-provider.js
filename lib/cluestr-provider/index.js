...
module.exports.createServer = function(config) {
  ...
  var queue = function(task, cb) {
    ...
    config.queueWorker(task, cluestrClient, cb);
  };
...
/**
 * Create a fake Cluestr server, to test interactions.
 */
module.exports.createTestFrontServer = require('./test-servers/front.js');


/**
 * Create a fake Cluestr API server, to test interactions.
 */
module.exports.createTestApiServer = require('./test-servers/api.js');

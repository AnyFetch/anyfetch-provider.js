...
module.exports.createServer = function(config) {
  ...
  server.get('/init/callback', initEndpoints.callback(config.connectAccountRetrievePreDatasIdentifier, config.connectAccountRetrieveAuthDatas, cluestrClient, config.connectUrl, config.redirectUrl || 'http://anyfetch.com'));
...
module.exports.debug = {
  createTestFrontServer: CluestrClient.debug.createTestFrontServer,
  createTestApiServer: CluestrClient.debug.createTestApiServer,

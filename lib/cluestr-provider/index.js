...
module.exports.createServer = function(config) {
  ...
  server.get('/init/callback', initEndpoints.callback(config.connectAccountRetrievePreDatas, config.connectAccountRetrieveAuthDatas, cluestrClient, config.connectUrl));

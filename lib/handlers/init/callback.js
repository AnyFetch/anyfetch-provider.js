  ...
  return function callbackGet(req, res, next) {
    ...
    async.waterfall([
      ...
      function createToken(accountName, providerData, tempToken, anyfetchAccessToken, cb) {
        ...
        console.log(tempToken.anyfetchToken || anyfetchAccessToken);

        Token.update({anyfetchToken: tempToken.anyfetchToken || anyfetchAccessToken}, upsertData, {upsert: true}, rarity.carryAndSlice([anyfetchAccessToken, tempToken], 3, cb));
      },

...
module.exports.createServer = function(config) {
  ...
  server.get('/init/callback', initEndpoints.callback(config.connectAccountRetrievePreDataIdentifier, config.connectAccountRetrieveAuthData, anyfetchClient, config.connectUrl, config.redirectUrl || 'http://settings.anyfetch.com'));

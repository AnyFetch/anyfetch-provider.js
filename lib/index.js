...
module.exports.createServer = function createServer(connectFunctions, updateAccount, workers, config) {
  ...
  server.post('/update', handlers.update.postGenerator(updateAccount, server.queue, workers, config));
  server.post('/update/:identifier', handlers.update.postGenerator(updateAccount, server.queue, workers, config));
